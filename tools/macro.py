...
maintained_icon     = ":material-check-circle:"
available_icon      = ":material-plus-circle:"
deprecated_icon     = ":material-alert-circle:"
unsupported_icon    = ":material-close-circle:"
...
def define_macros(vars):
    ...
    vars['maintained']  = f"{maintained_icon}{{.maintained title=\"Maintained\"}}"
